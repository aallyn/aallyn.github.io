...
title: about
permalink: /
description: Gulf of Maine Research Institute and the University of Massachusetts Amherst

profile:
  align: right
  image: prof_pic.jpg
  address: >
    <p>Gulf of Maine Research Instutute</p>
    <p>350 Commercial Street</p>
...
**Who am I?**  
My name is Andrew Allyn and I am a quantitative ecologist. Currently, I work as a quantitative research asssociate in [Dr. Kathy Mills' Integrated Systems Ecology Lab at the Gulf of Maine Research Institute](https://www.gmri.org/about-us/who-we-are/staff/kathy-mills-phd) in Portland, ME while nightlighting as a PhD student in the [University of Massachusetts' Intercampus Marine Science and Technology program](https://marine.massachusetts.edu/) with Dr. Curt Griffin. As someone who continues to benefit from the generosity of others providing their code, I am committed to open, reproducible and collaborative science. To that end, I provide all of my research code on [GitHub](https://github.com/aallyn). I am always interested in helping others adapt my code for their purposes, or chatting more generally about related analyses involving species distribution models, spatio-temporal models, climate change ecology, and ecological forecasting. I am also happy to discuss my work with more general audiences, especially college, high school or middle school students from under represented groups that have had limited exposure to the marine sciences world. When I am not behind the computer or in the field collecting data, I am likely outside, somewhere, exploring the outdoors.
